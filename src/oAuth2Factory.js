...
const { BITBUCKET_SETTINGS, GITLAB_SETTINGS, GITHUB_SETTINGS, DEFAULT_PROVIDER } = require('./constants')
...
function oAuth2Factory () {
  ...
  return new OAuth2Client(credentials, redirectUri, scopes, provider)
}
